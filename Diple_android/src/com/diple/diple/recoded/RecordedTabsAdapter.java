...
public class RecordedTabsAdapter extends FragmentPagerAdapter implements
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case MESSAGE_PAGE_CURRENT :
				...
				if (f != null && f instanceof RecordedPagerFragment) {
					((RecordedPagerFragment)f).onPageCurrent();
				}
			}
		}
	};
	...
	public RecordedTabsAdapter(FragmentActivity activity, TabHost tabHost,
			ViewPager pager) {
		this(activity,activity.getSupportFragmentManager(),tabHost,pager);
	}
	
	public RecordedTabsAdapter(Context context,FragmentManager fragmentManager, TabHost tabHost, ViewPager pager) {
